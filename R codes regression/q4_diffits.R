...
write.csv(data[influential_observations_dffits, ], "influential_observations_dffits.csv", row.names = FALSE, na = "")

influential_data <- data[influential_observations_dffits, ]
