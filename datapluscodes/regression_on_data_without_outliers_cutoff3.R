...
# Read the data
data <- read.csv("C:/Users/user/OneDrive/Study@IIITD/4th Semester/Econometrics/Eco Project/data_without_outliers_cutoff_3.csv")
...
p_values <- 2 * pt(abs(t_stats), df = length(y) - length(coefficients)) 
